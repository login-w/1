package com.wsx.blog.service.PreBlogService;

import com.wsx.blog.dao.BlogDao;
import com.wsx.blog.dao.PreBlogDao;
...
@Service
public class PreBlogServiceImpl implements PreBlogService {

    @Autowired
    private PreBlogDao dao;
    @Autowired
